...
public class TicTacToe {
    ...
    private static boolean checkTheWinner(String symbol) {
    ...
    private static int play(int turn) {
        ...
        System.out.println("Enter input for player " + turn + " where you want to put " + symbol);
        int position = scanner.nextInt();
        while (!validPosition(position)){
            System.out.println("invalid position");
            System.out.println("Enter input for player " + turn + " where you want to put " + position);
